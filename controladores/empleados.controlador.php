	...
	static public function ctrIngresoEmpleado(){
		...
		if(isset($_POST["ingEmpleado"])){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingEmpleado"])){
				...
				if($respuesta["empleado"] == $_POST["ingEmpleado"] && $respuesta["password"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						$_SESSION["empleado"] = $respuesta["empleado"];
						...
						echo '<br>
							<div class="alert alert-danger">El empleado aún no está activado</div>';
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])){
				...
				if(isset($_FILES["nuevaFoto"]["tmp_name"])){
					...
					/*=============================================
					CREAMOS EL DIRECTORIO DONDE VAMOS A GUARDAR LA FOTO DEL EMPLEADOS
					=============================================*/
					...
					if($_FILES["nuevaFoto"]["type"] == "image/jpeg"){
						...
						$ruta = "vistas/img/empleados/".$_POST["nuevoEmpleado"]."/".$aleatorio.".jpg";
					...
					if($_FILES["nuevaFoto"]["type"] == "image/png"){
						...
						$ruta = "vistas/img/empleados/".$_POST["nuevoEmpleado"]."/".$aleatorio.".png";

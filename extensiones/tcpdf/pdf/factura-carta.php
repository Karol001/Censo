...
$elementos = json_decode($respuestaVenta["elementos"], true);
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:260px; text-align:center">Elemento</td>
...
$itemElemento = "descripcion";
$valorElemento = $item["descripcion"];
$orden = null;

$respuestaElemento = ControladorElementos::ctrMostrarElementos($itemElemento, $valorElemento, $orden);

$valorUnitario = number_format($respuestaElemento["precio_venta"], 2);

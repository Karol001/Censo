  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarEmpleado"><i class="fa fa-user-plus" aria-hidden="true"></i>
          ...
          echo ' <tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-danger btnEliminarEmpleado" idEmpleado="'.$value["id"].'" fotoEmpleado="'.$value["foto"].'" empleado="'.$value["empleado"].'"><i class="fa fa-times"></i></button>
            ...
            <!-- ENTRADA PARA EL EMPLEADO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoEmpleado" placeholder="Ingresar empleado" id="nuevoEmpleado" required>
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/empleados/default/anonymous.png" class="img-thumbnail previsualizarEditar" width="100px">
